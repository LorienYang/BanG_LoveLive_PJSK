...
<img src="./BanG_Dream!_logo.svg" alt="BanG Dream! Logo" width="420" />
...
<p>
  <a href="https://github.com/HELPMEEADICE/china-bandori-maps"><img src="https://img.shields.io/badge/GitHub-china--bandori--maps-181717?style=for-the-badge&logo=github" alt="GitHub Repository" /></a>
  <img src="https://img.shields.io/badge/Static-Website-ff69b4?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Static Website" />
  <img src="https://img.shields.io/badge/License-GPLv3-blue?style=for-the-badge" alt="GPLv3 License" />
  <img src="https://img.shields.io/badge/Theme-Material%20Design%203-f06292?style=for-the-badge" alt="Material Design 3" />
</p>

<p>
  <img src="https://img.shields.io/badge/HTML5-Structure-E34F26?style=flat-square&logo=html5&logoColor=white" alt="HTML5" />
  <img src="https://img.shields.io/badge/CSS3-UI%20%26%20Responsive-1572B6?style=flat-square&logo=css3&logoColor=white" alt="CSS3" />
  ...
  <img src="https://img.shields.io/badge/D3.js-Visualization-F9A03C?style=flat-square&logo=d3.js&logoColor=white" alt="D3.js" />
  <img src="https://img.shields.io/badge/Mobile-Friendly-7c4dff?style=flat-square" alt="Mobile Friendly" />
  <img src="https://img.shields.io/badge/Data-API%20%2B%20Local%20Fallback-00b894?style=flat-square" alt="API and Local Fallback" />
</p>
...
```mermaid
graph TD
    HTML[index.html] --> UI[页面结构与 SEO]
    CSS[styles.css] --> UI
    JS[app.js] --> STATE[状态管理 / 交互逻辑]
    MAP[china.js] --> SVG[地图绘制]
    D3[D3.js] --> SVG
    DATA[bandori.json / API] --> JS
    STATE --> UI
    SVG --> UI
```
...
```mermaid
graph LR
    API[远程 API] -->|优先| RENDER[页面渲染]
    LOCAL[本地 JSON] -->|兜底| RENDER
```
